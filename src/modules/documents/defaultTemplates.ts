...
export const DEFAULT_SURAT_DISPENSASI_SCHEMA: FormFieldSchema[] = [
  ...
  },
  {
    ...
    helpText: 'Dapat ditujukan kepada Executive Management internal KIAN atau langsung ke Pimpinan Fakultas/Dosen Pengampu.',
  },
  {
    key: 'intro_text',
    label: 'Kalimat Pembuka',
    ...
    required: true,
    defaultValue:
      'Dengan hormat,\nSehubungan dengan pelaksanaan penugasan operasional kru dalam agenda kegiatan {event_name}, bersama ini saya selaku Program Director mengajukan permohonan penerbitan surat dispensasi perkuliahan resmi bagi personil mahasiswa/i yang bertugas pada:',
  },
  {
    key: 'event_name',
    ...
    defaultValue: [
      {
        ...
        university: 'Universitas Bina Sarana Informatika - UBSI Margonda',
        classCode: '17.3B.01',
        courses: [
          {
            courseCode: '876',
            ...
            room: 'E-D2',
            lecturerCode: 'AUM',
            lecturerName: 'Ade Surya Budiman',
            classCode: '17.3B.01',
            campusName: 'UBSI Margonda',
            notes: 'Perkuliahan Tatap Muka',
            selected: true,
          },
          {
            courseCode: '253',
            ...
            room: 'EL1-A1',
            lecturerCode: 'AHQ',
            lecturerName: 'Dr. Andika Hendra Mustaqim',
            classCode: '17.3B.01',
            campusName: 'UBSI Margonda',
            notes: 'Perkuliahan Online',
            selected: true,
          },
        ],
      },
  ...
  {
    key: 'show_stamp',
    label: 'Tampilkan Cap / Stempel Resmi',
    type: 'checkbox',
    required: false,
    defaultValue: true,
  },
  {
    key: 'show_qr_verification',
    label: 'Tampilkan QR Code Verifikasi Digital KIAN',
    type: 'checkbox',
    required: false,
    defaultValue: true,
  },
...
export const DEFAULT_SURAT_DISPENSASI_VALUES: Record<string, any> = {
